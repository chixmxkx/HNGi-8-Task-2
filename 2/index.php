    ...
    <header class="d-print-none">
      <div class="container text-center text-lg-left">
        <div class="pt-4 clearfix">
          <h1 class="site-title mb-0">Chiamaka Essonna</h1>
          <div class="site-nav"> 
            <nav role="navigation">
...
<div class="resume-container">
      ...
      <div class="cover bg-image"><img src="images/header-background.jpg"/>
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);backdrop-filter: blur(2px);">
          <div class="text-center p-5">
            <div class="avatar p-1"><img class="img-thumbnail shadow-2-strong" src="images/chixmxkx.jpeg" width="160" height="160"/></div>
            <div class="header-bio mt-3">
              <div data-aos="zoom-in" data-aos-delay="0">
                <h2 class="h1">Chiamaka Essonna</h2>
                <p>Backend Developer</p>
              </div>
              <heroku class="header-social mb-3 d-print-none" data-aos="zoom-in" data-aos-delay="200">
                <nav role="navigation">
                  <ul class="nav justify-content-center">
                    <li class="nav-item"><a class="nav-link" href="https://twitter.com/chixmxkx" title="Twitter"><i class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a>
                    </li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://instagram.com/chixmxkx" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="https://github.com/chixmxkx" title="Github"><i class="fab fa-github"></i><span class="menu-title sr-only">Github</span></a>
                    </li>
                  </ul>
                </nav>
              </div>
              <div class="d-print-none"><a class="btn btn-outline-light btn-lg shadow-sm mt-1 me-3" href="ChiamakaEssonna_CV .pdf" target="_blank" data-aos="fade-right" data-aos-delay="700">Download CV</a><a class="btn btn-info btn-lg shadow-sm mt-1" href="#contact" data-aos="fade-left" data-aos-delay="700">Hire Me</a></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="about-section">
      <div class="row">
        <div class="col-md-6">
          ...
          <p>Hi, my name is Chiamaka and I am a <strong> backend developer </strong> with specialty in Laravel. I developed interest in programming in October 2020 and I am still at it. I know HTML and CSS, and have beginner knowledge in Javascript and Python. I am a quick learner and a team worker that gets the job done. </p>
          <p>I am available for hire and open to collaborations.</p>
        </div>
        <div class="col-md-5 offset-lg-1">
          <div class="row mt-2">
            ...
            <div class="col-sm-7">
              <div class="pb-2">beautifulessonna@gmail.com</div>
            </div>
            <div class="col-sm-5">
      ...
      <div class="row">
        ...
        <!-- <div class="col-md-6"
          <div class="mb-3"><span class="fw-bolder">JavaScript</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-info" role="progressbar" data-aos="zoom-in-right" data-aos-delay="200" data-aos-anchor=".skills-section" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">Beginner</div>
            </div>
          <div class="mb-3"><span class="fw-bolder">Python</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-info" role="progressbar" data-aos="zoom-in-right" data-aos-delay="600" data-aos-anchor=".skills-section" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">Beginner</div>
            </div> -->
          </div>
        </div>
      </div>
      ...
      <div class="timeline">
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="0">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Intern <span class="text-muted h6">at The Lagos Multi-Door Courthouse, Igbosere, Lagos</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">March, 2019 - April, 2019</div>
            <div>Worked with the ADR track team in handling real-life mediation cases. Wrote briefs daily for out-of-court mediation cases. Scheduled convenient meetings for both mediator and parties.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="200">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Trainee<span class="text-muted h6"> at Zuri x I4G</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">March, 2021 - July, 2021</div>
            <div>Hands on experience on real-life projects. Built the back-end profile API for KidVacc, a vaccination app that enables parents book appointments in nearby pediatric hospitals.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="400">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Team Player <span class="text-muted h6">at Women Techsters Bootcamp</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">May, 2021 - June, 2021</div>
            <div>Created a website focused on domestic violence and women empowerment.</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 d-flex align-items-center" data-aos="fade-left" data-aos-delay="100">
          <div class="m-4 mt-md-2">
            <p class="text-teal text-small">Backend / PHP / Laravel</p>
            <h3>Two Factor Authentication System</h3>
            <p class="text-muted">Built a two factor authentication system using Laravel that allows user access the pages only if the correct security key is inputted.</p>
          </div>
        </div>
      </div>
      <div class="row g-0 portfolio-reverse">
        <div class="col-md-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
          <div class="m-4 mt-md-2 text-end">
            <p class="text-teal text-small">Backend / PHP / Laravel</p>
            <h3>Donation App</h3>
            <p class="text-muted">Built an app that allows a user to register, donate and receive items. A combination of frontend and backend for the finished product.</p>
          </div>
        </div>
      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 d-flex align-items-center" data-aos="fade-left" data-aos-delay="100">
          <div class="m-4 mt-md-2">
            ...
            <h3>Womxn Website</h3>
            <p class="text-muted">Built highly performant website for a women agency focused on women empowerment and reducing gender based violence. Delivered codebase in HTML, CSS and modern JavaScript.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="contant-section">
      ...
      <div class="row mb-4">
        <div class="col-md-5" data-aos="fade-left" data-aos-delay="200">
          <div class="mt-1">
            <div class="h6"><i class="fas fa-phone pe-2 text-muted" style="width:24px;opacity:0.85;"></i> +234 905 073 0350</div>
            <div class="h6"><i class="far fa-envelope pe-2 text-muted" style="width:24px;opacity:0.85;"></i> beautifulessonna@gmail.com</div>
          </div>
  ...
  <button class="btn btn-info btn-block mb-4" type="submit">Send</button>
    ...
    <footer class="pt-4 pb-4 text-muted text-center d-print-none">
      <div class="container">
        <div class="my-3">
          <!-- <div class="h4">Chiamaka Essonna</div> -->
          <div class="h4">Zuri Internship, I4G x HNGi8</div>
          <div class="footer-nav">
            <nav role="navigation">
              <ul class="nav justify-content-center">
                <div class="col-md-6"><a href="https://zuri.team/" target="_blank"><img class="img-fluid" src="images/zuri.jpeg" width="60" height="60"/></a></div>
                <div class="col-md-6"><a href="https://ingressive.org/" target="_blank"><img class="img-fluid" src="images/I4G.jpeg" width="60" height="60"/></a></div>
                <div class="col-md-6"><a href="https://hng.tech/" target="_blank"><img class="img-fluid" src="images/hng.jpeg" width="60" height="60"/></a></div>
              </ul>
              <!-- <ul class="nav justify-content-center">
                <li class="nav-item"><a class="nav-link" href="https://twitter.com/chixmxkx" title="Twitter"><i class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a>
                </li>
                <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/templatefl" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a> -->
                <!-- </li>
                <li class="nav-item"><a class="nav-link" href="https://instagram.com/chixmxkx" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a>
                </li>
                <li class="nav-item"><a class="nav-link" href="https://github.com/chixmxkx" title="Github"><i class="fab fa-github"></i><span class="menu-title sr-only">Github</span></a>
